...
const defaultExperiences = [
  {
    ...
    description: [
      "Membangun platform e-commerce dari nol dengan fitur manajemen inventaris dan perhitungan pengiriman flat-rate.",
      "Melakukan integrasi payment gateway menggunakan Midtrans untuk transaksi yang aman dan terotomatisasi.",
      "Mengelola infrastruktur deployment dan manajemen server secara mandiri.",
    ],
    technologies: ["Next.js", "Express.js", "Midtrans", "Linux"],
  },
  {
    company: "Yayasan Program Nutrisi (Nutritional Program Foundation)",
    role: "Senior Software Developer",
    period: "2026 - Sekarang",
    location: "Payakumbuh, Indonesia",
    description: [
      "Merancang dan mengembangkan aplikasi manajemen terpadu untuk operasional yayasan.",
      "Membangun fitur pelacakan pengiriman makanan sekolah (school meal deliveries) secara real-time.",
      "Mengimplementasikan sistem absensi dan pelacakan kehadiran staf yang akurat.",
    ],
    technologies: ["Next.js", "React", "Node.js", "PostgreSQL"],
  },
  {
    company: "Freelance (US Construction & Travel Agency)",
    role: "Full-stack Developer",
    period: "2025 - 2026",
    location: "Remote",
    description: [
      "Mengembangkan aplikasi web CRM kustom untuk klien industri travel, dilengkapi dengan dashboard khusus untuk hak akses Agent dan Admin.",
      "Merancang dan membangun live demo interaktif serta website portofolio berkinerja tinggi untuk perusahaan konstruksi berbasis di Amerika Serikat.",
    ],
...
export default function Experience({ dict }) {
  ...
  const technologiesLabel =
    dict?.technologiesLabel || "Teknologi yang digunakan:";
  const experienceList = dict?.list || defaultExperiences;
